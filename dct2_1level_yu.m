 function dctima = dct2_1level_yu(ima)

 vectors = [ 0.35355339,  0.35355339,  0.35355339,  0.35355339  0.35355339,  0.35355339,  0.35355339,  0.35355339;
...
newima = zeros(size(ima));

    for i = 1:size(ima, 1)
        for j = 1:size(ima, 2)          
            for k = 1: size(ima, 3)
                temp = ima(i,j,:);
                newima(i,j,k) = dot(temp(:), vectors(k,:));
            end
        end
    end    

% figure;imagesc(newima(:,:,1))
